                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Add_cat.php" class="dropdown-item">Add category</a>
                            <a href="update_cat.php" class="dropdown-item">update Category</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Add_pro.php" class="dropdown-item">Add Products</a>
                            <a href="update_pro.php" class="dropdown-item">Update Products</a>
                            <!-- <a href="element.html" class="dropdown-item">Other Elements</a> -->
                        </div>
                    </div>
